 ...
 * Time: 10:34 AM
 */
public class SplashHistVersion3Test extends AbstractSpectraHashImplTester
{
     ...
     */
    private static final String REGEX = "splash[1-5][0-9a-z]-[a-z0-9]{10}-[a-z0-9]{20}-[0-9]{20}";
    ...
    public void testCalculate4thBlock() throws Exception {
        ...
        SplashHistVersion3 splash = getHashImpl();
        ...
        assertEquals("24004900000099000000", block);

    }

    @Override
    SplashHistVersion3 getHashImpl() {
