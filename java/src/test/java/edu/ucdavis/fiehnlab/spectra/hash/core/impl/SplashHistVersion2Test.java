 ...
 * Time: 10:34 AM
 */
public class SplashHistVersion2Test extends AbstractSpectraHashImplTester
{
    ...
    public void testCalculate4thBlock() throws Exception {
        ...
        SplashHistVersion2 splash = getHashImpl();
        ...
        assertEquals("1930000000",block);

    }

    @Override
    SplashHistVersion2 getHashImpl() {
        return new SplashHistVersion2();
    }
}