...
def validate_splash(input_file, output_file, separator, spectrum_type, spectrum_col, origin_col, splash_col):
    return
...
if __name__ == '__main__':
    ...
    parser.add_argument('output_file', help = 'output validation file')
