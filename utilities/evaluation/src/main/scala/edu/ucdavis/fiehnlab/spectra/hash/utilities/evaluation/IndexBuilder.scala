...
class IndexBuilder {
  ...
  def buildBestIndexes: List[Index] = {
    ...
    val histogramList: List[Histogram] =  LongBase64NoToleranceHistogram :: LongBase64SmallToleranceHistogram :: LongBase64MediumToleranceHistogram :: LongBase64LargeToleranceHistogram:: ShortBase64NoToleranceHistogram :: ShortBase64SmallToleranceHistogram :: List()
      Seq(8, 10).collect {
