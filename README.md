...
## java api:
The reference implementation jar file can be downloaded from: http://gose.fiehnlab.ucdavis.edu:55000/content/groups/public/edu/ucdavis/fiehnlab/splash/core/1.8/core-1.8.jar
...
As part of the splash specificitation, we are providing a simple validation tool, in the validation folder.
	...
	The latest jar can be found at: http://gose.fiehnlab.ucdavis.edu:55000/content/groups/public/edu/ucdavis/fiehnlab/splash/validation/1.8/validation-1.8.jar
